...
export const chapter5Lesson = [
  // --- Section A: Adding Decimals ---
  {
    ...
    story: 'Steve buys a sword for 2.50 emeralds and a shield for 1.25 emeralds. How much total? Line up the decimal points and add!',
  ...
  },
  {
    type: 'interactive',
    title: 'Add These!',
    story: 'Steve finds 1.30 emeralds in a chest and 2.50 more in another chest.',
    question: '1.30 + 2.50 = ?',
  ...
  },
  {
    ...
    story: 'A potion costs 1.5 emeralds. A bread costs 0.75 emeralds.',
    question: '1.5 + 0.75 = ?',
  ...
  // --- Section B: Subtracting Decimals ---
  {
    ...
    story: 'Steve has 5.00 emeralds. He spends 2.35 on arrows. How much is left? Same rule: line up the decimal points!',
  ...
  },
  {
    ...
    story: 'Steve has 3.5 emeralds. He spends 1.25. Pad with a zero first: 3.50 - 1.25.',
  ...
  },
  {
    ...
    story: 'Steve has 4.50 emeralds and spends 1.20.',
    question: '4.50 - 1.20 = ?',
  ...
  },
  {
    ...
    story: 'Alex has 2.00 emeralds. She buys a map for 0.75.',
    question: '2.00 - 0.75 = ?',
  ...
  // --- Section C: Multiplying Decimals ---
  {
    ...
    story: 'Each apple costs 0.25 emeralds. Steve buys 3 apples. How much total? Multiply then count decimal places!',
  ...
  },
  {
    type: 'interactive',
    title: 'Multiply!',
    story: 'Each arrow costs 0.50 emeralds. Steve buys 4 arrows.',
    question: '0.50 x 4 = ?',
  ...
  },
  {
    ...
    story: 'Steve needs 0.5 of 0.4 of a block.',
    question: '0.5 x 0.4 = ?',
  ...
  // --- Section D: Money Problems ---
  {
    type: 'teach',
    title: 'Money Math!',
    story: 'Steve goes to the village shop. A cake costs $3.50 and milk costs $1.75. Decimals are perfect for money!',
  ...
  },
  {
    type: 'interactive',
    title: 'Shopping Trip!',
    story: 'Steve buys a pickaxe for $4.25 and a torch for $0.50.',
    question: 'How much does Steve spend?',
  ...
  },
  {
    type: 'interactive',
    title: 'Making Change!',
    story: 'Steve pays $5.00 for something that costs $3.25.',
    question: 'How much change does Steve get?',
  ...
  },
  {
    ...
    story: 'Each cookie costs $0.75. Steve buys 2 cookies.',
    question: 'How much does Steve pay?',
  ...
  },
  {
    type: 'interactive',
    title: 'Match Them!',
    story: 'Steve knows that 1/2 = 0.5.',
  ...
  },
  {
    ...
    story: 'Alex sees the number 0.25.',
...
export const chapter5Quiz = [
  ...
  {
    prompt: 'Steve buys 3 apples at $0.50 each. How much?',
    emoji: '💎',
  ...
  },
  {
    ...
    generate() {
      ...
      if (isAdd) {
        ...
        return {
          prompt: `Steve buys items for $${a.toFixed(2)} and $${b.toFixed(2)}. How much total?`,
          emoji: '💎',
          choices: choices.map(c => c.text),
          correctIndex: choices.findIndex(c => c.correct),
        ...
        return {
          prompt: `Steve pays $${total}.00 for something that costs $${cost.toFixed(2)}. How much change?`,
          emoji: '💎',
          choices: choices.map(c => c.text),
          correctIndex: choices.findIndex(c => c.correct),
