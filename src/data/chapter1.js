...
export const chapter1Lesson = [
  ...
  // --- Section E: Distributive Law Intro ---
  {
    type: 'teach',
    title: 'Bonus Law!',
    story: 'Dave found 2 treasure chests! Each chest has 3 gold coins and 2 silver coins. That is 5 coins per chest.',
    groups: [
      { emoji: '🥇', count: 3, label: 'Gold coins' },
      { emoji: '🥈', count: 2, label: 'Silver coins' },
    ],
    equation: '2 x (3 + 2) = 2 x 5 = 10',
    highlight: '10 coins total!',
  },
  {
    type: 'teach',
    title: 'Count Each Type!',
    story: 'Or count each coin type separately: 2 chests x 3 gold = 6 gold. 2 chests x 2 silver = 4 silver.',
    equation: '(2 x 3) + (2 x 2) = 6 + 4 = 10',
    highlight: 'Same answer! This is the Distributive Law!',
  },
  {
    type: 'interactive',
    title: 'Distributive Challenge!',
    story: 'Dave has 3 bags. Each bag has 2 gold coins and 1 diamond.',
    question: '3 x (2 + 1) = ?',
    choices: ['9', '8', '6'],
    correctIndex: 0,
    explanation: '3x2=6 gold and 3x1=3 diamonds. Then 6+3=9! Or: 3x3=9!',
  },
]
